# kafka-go [![CircleCI](https://circleci.com/gh/apoorvag-mav/kafka-go.svg?style=shield)](https://circleci.com/gh/apoorvag-mav/kafka-go) [![Go Report Card](https://goreportcard.com/badge/github.com/apoorvag-mav/kafka-go)](https://goreportcard.com/report/github.com/apoorvag-mav/kafka-go) [![GoDoc](https://godoc.org/github.com/apoorvag-mav/kafka-go?status.svg)](https://godoc.org/github.com/apoorvag-mav/kafka-go)
...
`kafka-go` is currently compatible with golang version from 1.13+. To use with older versions of golang use release [v0.2.5](https://github.com/apoorvag-mav/kafka-go/releases/tag/v0.2.5).

## Connection [![GoDoc](https://godoc.org/github.com/apoorvag-mav/kafka-go?status.svg)](https://godoc.org/github.com/apoorvag-mav/kafka-go#Conn)
...
## Reader [![GoDoc](https://godoc.org/github.com/apoorvag-mav/kafka-go?status.svg)](https://godoc.org/github.com/apoorvag-mav/kafka-go#Reader)
...
## Writer [![GoDoc](https://godoc.org/github.com/apoorvag-mav/kafka-go?status.svg)](https://godoc.org/github.com/apoorvag-mav/kafka-go#Writer)
...
#### [Plain](https://godoc.org/github.com/apoorvag-mav/kafka-go/sasl/plain#Mechanism)
```go
...
#### [SCRAM](https://godoc.org/github.com/apoorvag-mav/kafka-go/sasl/scram#Mechanism)
```go
