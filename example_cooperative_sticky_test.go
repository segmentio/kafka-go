...
// the RackFunc field for lazy/dynamic AZ discovery. This pattern is similar to
// what bulrush uses for automatic AZ detection.
//
...
// an MSK-optimized setup with automatic AZ zone ID detection, similar to bulrush.
//
